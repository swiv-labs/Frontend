            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              {externalLinks.map((link) => (
                <a
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-smooth rounded-lg"
                >
                  {link.label}
                  <svg
            ...
            >
              ...
              {externalLinks.map((link) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition-smooth rounded-lg"
                >
                  {link.label}
                  <svg
                    className="h-3.5 w-3.5"
