          ...
          >
            ...
            >
              ...
              <div className="flex gap-2 w-full">
                <div className="w-2/5">
                  <Image className="w-[256px] h-[130px] object-cover rounded-lg" src={pool.metadata ? pool.metadata : "https://bernardmarr.com/wp-content/uploads/2025/01/bitcoin.jpg"} alt={"pool image"} width={500} height={500} />
                </div>
